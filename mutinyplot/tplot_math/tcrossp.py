import numpy as np
from mutinyplot import get_data, store_data
...
def tcrossp(
    ...
    --------
        ...
        >>> mutinyplot.store_data("a", data={"x": time1, "y": [[1, 2, 3],[2, 3, 4],[3, 4, 5]]})
        >>> mutinyplot.store_data("c", data={"x": time2, "y": [[1, 4, 1],[2, 5, 2],[3, 5, 3]]})
        >>> n = mutinyplot.tcrossp("a", "c", newname="a_cross_c")
