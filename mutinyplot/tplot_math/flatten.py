...
def flatten(tvar, range=None, newname=None, new_tvar=None):
    ...
    --------
        ...
        >>> mutinyplot.flatten('d',[8,14],'d_flatten')
        >>> print(mutinyplot.data_quants['d_flatten'].values)
    """
    ...
    if "spec_bins" in mutinyplot.data_quants[tvar].coords:
        df, s = mutinyplot.tplot_utilities.convert_tplotxarray_to_pandas_dataframe(tvar)
    else:
