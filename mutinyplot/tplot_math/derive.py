...
def derive(tvar,newname=None, new_tvar=None):
    ...
    --------
        ...
        >>> mutinyplot.derive('b','dbdt')
        >>> print(mutinyplot.data_quants['dbdt'].values)
    """
    ...
    a = mutinyplot.data_quants[tvar].differentiate('time')
    if newname is None:
        a.name = tvar
        ...
        mutinyplot.store_data(newname, data=data)
