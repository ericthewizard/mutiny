...
from mutinyplot import get_data, store_data, options, time_double
...
def tdpwrspc(
    ...
    ----------
    varname: str
        Name of mutinyplot variable.
    newname: str, optional
        Name of new mutinyplot variable to save data to.
    ...
    -------
    str
        Name of new mutinyplot variable.
    ...
    -------
        ...
        >>> import mutinyplot
        >>> import numpy as np
        >>> from mutinyplot import tplot_math
        >>> mutinyplot.store_data('a', data={'x': range(3000), 'y': np.random.random(3000)})
        >>> mutinyplot.tplot_math.tdpwrspc('a')
    """
    if newname is None:
