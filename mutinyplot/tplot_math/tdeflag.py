...
def tdeflag(names,
    ...
    newname: str/list of str, optional
        ...
        If '', then mutinyplot variables are replaced.
    ...
    -------
    list of str
        List of mutinyplot variables created or altered by tdeflag
    ...
    >>> d_deflagged = mutinyplot.get_data('e')
    >>> print(d_deflagged)
    """
    ...
    if len(old_names) < 1:
        logging.error('tdeflag error: No mutinyplot names were provided.')
        return None
    ...
    for i in range(len(old_names)):
        mutinyplot.deflag(old_names[i], flag, newname=n_names[i], method=method, fillval=fillval)
