import logging
import numpy as np
from mutinyplot import tnames, get_data, store_data, options
...
def tpwrspc(varname, newname=None, overwrite=False, noline=False, nohanning=False, bin=3, notperhz=False, trange=None, axis=0):
    ...
    It applies pwrspc to a mutinyplot variable and stores the result in a new mutinyplot variable.
    ...
    --------
        ...
        >>> mutinyplot.tpwrspc('a')
        >>> mutinyplot.get_data('a_pwrspc')
    """
