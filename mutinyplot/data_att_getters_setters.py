import logging
from mutinyplot import get_data
...
def get_any(name,tag_name):
    ...
    ----------
        ...
        >>> mutinyplot.data_att_getters_setters.get_any('tha_pos', 'coord_sys')
...
def set_any(name, tag_name, tag_value):
    ...
    ----------
        ...
        >>> from pyspedas import themis
        >>> themis.state(trange=['2007-06-23', '2007-06-24'], probe='a')
        >>> mutinyplot.data_att_getters_setters.set_any('tha_pos', 'coord_sys', 'GSE')
...
def set_coords(name, coords):
    ...
    ----------
        ...
        >>> from pyspedas import themis
        >>> themis.state(trange=['2007-06-23', '2007-06-24'], probe='a')
        >>> mutinyplot.set_coords('tha_pos', 'GEI')
    """
...
def set_units(name, units):
    ...
    ----------
        ...
        >>> from pyspedas import themis
        >>> themis.state(trange=['2007-06-23', '2007-06-24'], probe='a')
        >>> mutinyplot.set_units('tha_pos', 're')
    """
