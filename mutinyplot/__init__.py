...
logging_level = environ.get('mutinyplot_LOGGING_LEVEL')
logging_format = environ.get('mutinyplot_LOGGING_FORMAT')
logging_date_fmt = environ.get('mutinyplot_LOGGING_DATE_FORMAT')
