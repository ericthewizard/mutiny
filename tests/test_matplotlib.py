...
from mutinyplot import get_data, store_data, options, tplot_options, cdf_to_tplot, tlimit, timebar
import os
...
def test_highlight():
    ...
    mutinyplot.highlight('mms1_dis_bulkv_gse_brst', [1445000760.0, 1445000820.0])
    tplot(panels, display=False, save_png=current_directory + 'highlight_interval')
    mutinyplot.highlight('mms1_dis_bulkv_gse_brst', None)
