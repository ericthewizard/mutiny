...
def tdeflag(names,
    ...
    newname: str/list of str, optional
        ...
        If '', then mutiny variables are replaced.
    ...
    -------
    list of str
        List of mutiny variables created or altered by tdeflag
    ...
    if len(old_names) < 1:
        logging.error('tdeflag error: No mutiny names were provided.')
        return None
    ...
    for i in range(len(old_names)):
        mutiny.deflag(old_names[i], flag, newname=n_names[i], method=method, fillval=fillval)
