...
from mutiny import get_data, store_data, options, time_double
...
def tdpwrspc(
    ...
    ----------
    varname: str
        Name of mutiny variable.
    newname: str, optional
        Name of new mutiny variable to save data to.
    ...
    -------
        ...
        >>> import mutiny
        >>> import numpy as np
        >>> from mutiny import tplot_math
        >>> mutiny.store_data('a', data={'x': range(3000), 'y': np.random.random(3000)})
        >>> mutiny.tplot_math.tdpwrspc('a')
    """
    if newname is None:
