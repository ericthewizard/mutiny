import numpy as np
from mutiny import get_data, store_data
...
def tcrossp(
    ...
    --------
        ...
        >>> mutiny.store_data("a", data={"x": time1, "y": [[1, 2, 3],[2, 3, 4],[3, 4, 5]]})
        >>> mutiny.store_data("c", data={"x": time2, "y": [[1, 4, 1],[2, 5, 2],[3, 5, 3]]})
        >>> n = mutiny.tcrossp("a", "c", newname="a_cross_c")
